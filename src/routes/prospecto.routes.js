...
router.get("/documentos/status/:rfc", checkDocumentosDescargados); // Verificar estado de documentos descargados
...
router.get("/sendData/:idSolicitud", sendDataBySolicitud);         // Enviar datos prospecto por idSolicitud
